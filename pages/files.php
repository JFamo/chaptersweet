...
if(isset($_POST['uploadFile']) && $_FILES['userfile']['size'] > 0){
	...
	$query = "INSERT INTO minutes (name, size, type, content, date, view, poster, chapter) VALUES ('$fileName', '$fileSize', '$fileType', '$content', now(), '$view', '$poster', '$chapter')";
	...
	$activityForm = "Uploaded File " . $fileName;
			...
			<div class="row">
				<div class="col-10">
					...
					<p class="" style="padding-left:20px;">
						Important TSA <span class="text-primary">Resources</span>
					</p>
				</div>
				<div class="col-2">
					  ...
					  <div class="modal-dialog" role="document">
					    <div class="modal-content">
					      <div class="modal-header">
					        <h5 class="modal-title" id="helpModalTitle">About Files</h5>
					        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
					          <span aria-hidden="true">&times;</span>
					        </button>
					      </div>
					      <div class="modal-body">
					        The Files page contains important files uploaded by your chapter's officers and adviser.
					        <hr>
